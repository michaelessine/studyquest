...
const MATHEMATICS: TopicDef[] = [
  ...
  { name: 'Risk analysis', tier: 2, category: 'Probability & Statistics', prereqs: ['Basics of Probability', 'Basics of Statistics'] },
  { name: 'Stochastic processes', tier: 2, category: 'Probability & Statistics', prereqs: ['Basics of Probability', 'Real analysis'] },
  { name: 'Multivariate statistical analysis', tier: 2, category: 'Probability & Statistics', prereqs: ['Basics of Statistics', 'Linear algebra'] },
  { name: 'Time series analysis', tier: 2, category: 'Probability & Statistics', prereqs: ['Basics of Statistics', 'Stochastic processes'] },
  ...
  { name: 'Topological data analysis', tier: 4, category: 'Topology & Geometry', prereqs: ['Algebraic topology', 'Basics of Statistics'] },
...
const COMPUTER_SCIENCE: TopicDef[] = [
  ...
  { name: 'Randomized algorithms', tier: 3, category: 'Theory', prereqs: ['Principles of Algorithmic Techniques', 'Basics of Probability'] },
...
const ECONOMICS: TopicDef[] = [
  ...
  { name: 'Econometrics', tier: 1, category: 'Quantitative Methods', prereqs: ['Basics of microeconomics', 'Basics of Statistics'] },
...
const OTHERS: TopicDef[] = [
  ...
  { name: 'Brownian motion (stat phys)', tier: 1, category: 'Physics', prereqs: ['Basics of Probability'] },
  { name: 'Monte Carlo simulations', tier: 2, category: 'Physics', prereqs: ['Basics of Probability'] },
